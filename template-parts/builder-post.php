...
<?php while(has_sub_field('post_builder')): ?>
			...
			<div class="row justify-content-center">
				<div class="col-12 col-lg-8 col-xxl-6">
					...
					<?php if(get_sub_field('unit_subheading_select') == 'subheadingh2') : ?>
						<h2 class="atm--post-h2"><?php the_sub_field('unit_subheading_text');?></h2>
	...
	<?php if(get_row_layout() == 'post_subheading_h2'): // Subheading: h2 TODELETE ?>
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-12 col-lg-8 col-xxl-6"> 
	...
	<?php if(get_row_layout() == 'post_subheading_h3'): // Subheading: h3 TODELETE ?>
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-12 col-lg-8 col-xxl-6"> 
	...
	<?php if(get_row_layout() == 'post_subheading_h4'): // Subheading: h4 TODELETE ?>
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-12 col-lg-8 col-xxl-6"> 
	...
	<?php if(get_row_layout() == 'post_bullet_list'): // Bullet List TODELETE ?>
		<div class="container-fluid">
	        <div class="row justify-content-center">
	            <div class="col-12 col-lg-8 col-xxl-6">
	                <section class="mol--list">
    ...
    <?php endif; ?>
    <?php if(get_row_layout() == 'post_number_list'): // Number List TODELETE  ?>
    	<div class="container-fluid">
	        <div class="row justify-content-center">
	            <div class="col-12 col-lg-8 col-xxl-6">
	                <section class="mol--list">
